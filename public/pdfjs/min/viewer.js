...
var DEFAULT_DOMAIN = typeof(default_domain)!='undefined'?default_domain:'';
...
(function () {
    ...
    (function (root, factory) {
        ...
        function configure(PDFJS) {
            PDFJS.imageResourcesPath = DEFAULT_DOMAIN + '/pdfjs/min/images/';
            PDFJS.workerSrc = DEFAULT_DOMAIN + '/pdfjs/min/pdf.worker.min.js';
                ...
                firstPagePromise.then(function(pdfPage) {
                    ...
                    store.initializedPromise.then(function resolved() {
                        ...
                        if (self.preferenceShowPreviousViewOnLoad &&
                            ...
                            var pageNum = 1 || store.get('page', '1');
                            var zoom = default_scale_value || self.preferenceDefaultZoomValue ||
                                store.get('zoom', DEFAULT_SCALE_VALUE);
                            var left = 0 || store.get('scrollLeft', '0');
                            var top = 0 || store.get('scrollTop', '0');
                        ...
                        // } else if (self.preferenceDefaultZoomValue) {
                            ...
                            storedHash = 'page=1&zoom=' + default_scale_value;
                        }
