...
//        $this->setOption('fileType', strtolower($aryStr[count($aryStr)-1]));
        $this->setOption('fileType', str_replace('.','',Common::getImageTypeByPath($tmp_name)));
